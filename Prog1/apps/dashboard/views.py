...
from apps.login.models import Usuario, Nivelvendedor, Filial, Localidade, Nivelfilial
from apps.dashboard.forms import UsuarioForm, LocalidadeForm, NivelFilialForm
